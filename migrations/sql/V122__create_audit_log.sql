...
-- IMMUTABILITY RULES: Protects database records from being updated or deleted by anyone
...
-- FORCE RLS: Guarantees that even Superusers (postgres) cannot bypass tenant isolation bounds
